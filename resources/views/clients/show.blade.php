            ...
            <div class="col-6 col-md-4 col-xl-2">
                <section class="card h-100">
                    <div class="card-body">
                        ...
                        @if (! $item['authorized'])
                            <span class="d-block small text-secondary">Restricted</span>
                        @elseif (! $item['implemented'])
                        ...
                        @elseif ($key === 'payments' && auth()->user()->hasPermission('payments.view'))
                            <a class="stretched-link small" href="{{ route('clients.payments', $client) }}"><span class="visually-hidden">View </span>View history</a>
                        @elseif ($key === 'invoices' && auth()->user()->hasPermission('invoices.view'))
                            <a class="stretched-link small" href="{{ route('clients.invoices', $client) }}"><span class="visually-hidden">View </span>View history</a>
                        @elseif ($key === 'communications')
                            <span class="d-block small text-secondary">Recorded in Event workspaces</span>
                        @else
